...
namespace AzureMLDemo
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            for (int row = 0; row < 8; row++)
            {
                for (int col = 0; col < 8; col++)
                {
                    ...
                    cell.PointerPressed += CellOnPointerPressed;
                    cell.PointerEntered += CellOnPointerEntered;
        ...
        private void CellOnPointerEntered(object sender, PointerRoutedEventArgs pointerRoutedEventArgs)
        {
            var cell = (Rectangle)sender;

            if (pointerRoutedEventArgs.Pointer.PointerDeviceType == PointerDeviceType.Mouse)
            {
                var point = pointerRoutedEventArgs.GetCurrentPoint(null);
        ...
        private void CellOnPointerPressed(object sender, PointerRoutedEventArgs pointerRoutedEventArgs)
        {
            if (pointerRoutedEventArgs.Pointer.PointerDeviceType == PointerDeviceType.Mouse)
            {
                var point = pointerRoutedEventArgs.GetCurrentPoint(null);
